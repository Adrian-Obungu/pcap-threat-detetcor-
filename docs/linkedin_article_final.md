...
This project taught me more than any textbook could. Developing on an iPad forced me to think in the cloud, rely on automation, and focus on core logic. It also highlighted the reality of modern security: we are moving away from "What is this file?" toward "Does this behavior belong here?" [7].
