...
### **Where to Explore & Interact**

I've made the entire project open-source for anyone who wants to dive into the logic or replicate the tests. You can view the repository here:

🚀 **GitHub Repository:** [Adrian-Obungu/pcap-threat-detector](https://github.com/Adrian-Obungu/pcap-threat-detetcor-)

**How to interact with the project:**
*   **The Core Logic:** Explore `src/detector/detector.py` to see the Scapy-based rules and the $O(n)$ sliding window implementation.
*   **The AI Pipeline:** Check out `src/detector/feature_extractor.py` and `src/detector/ai_detector.py` to see how raw packets are transformed into flow-based features for the Isolation Forest model.
*   **The Results:** Review the `data/logs/` directory to see the hybrid threat reports, where rule-based alerts are validated by AI anomaly scores.
